...
Navigate to Insights listing page from Home Page
    ...
    wait until element is visible   ${Resource_card_Xpath}      30
    page should contain element     ${Resource_card_Xpath}
   # ${Resource_type_Xpath}=     get text    ${Resource_type_Xpath}
   # wait until element is visible   ${Resource_type_Xpath}     20
...
Navigate to Article details page from listing page
   ...
   # page should contain element     ${Resource_card_content_Xpath}
    page should contain element     ${Resource_card_title_Xpath}
    log to console      ${Resource_card_title_Xpath}
    click element   ${Resource_card_title_Xpath}
 #  wait until element is visible   ${Resource_type_tag_Xpath}  40
    wait until element is visible   ${Resource_detail_page_title_Xpath}   30
    page should contain element     ${Resource_detail_page_title_Xpath}
    page should contain element     ${Resource_type_tag_Xpath}
    log to console      ${Resource_detail_page_title_Xpath}
